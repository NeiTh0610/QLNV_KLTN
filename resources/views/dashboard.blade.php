        ...
        <div class="card-body p-4">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
                    <a href="{{ route('attendance.check-in') }}" class="btn btn-light btn-lg">
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-6 col-xl-3">
            <div class="card stat-card">
                ...
                @if(!$todayAttendance)
                <a href="{{ route('attendance.check-in') }}" class="btn btn-sm btn-gradient">
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card stat-card">
                ...
                <h3 class="fw-bold mb-0">{{ $monthlyWorkingDays ?? 0 }}</h3>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card stat-card">
                ...
                <h3 class="fw-bold mb-0">{{ $pendingLeaves ?? 0 }}</h3>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card stat-card">
                ...
                <h3 class="fw-bold mb-0">{{ number_format(($currentMonthSalary ?? 0) / 1000000, 1) }}M</h3>
                <small class="text-muted">{{ number_format($currentMonthSalary ?? 0, 0, ',', '.') }}đ</small>
            </div>
        </div>
    </div>
            ...
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="p-3 rounded-3" style="background: linear-gradient(135deg, #11998e15 0%, #38ef7d15 100%);">
                                ...
                                <h4 class="fw-bold mb-0">
                                    {{ $todayAttendance->check_in_at ? \Carbon\Carbon::parse($todayAttendance->check_in_at)->format('H:i') : '--:--' }}
                                </h4>
                        ...
                        <div class="col-6">
                            <div class="p-3 rounded-3" style="background: linear-gradient(135deg, #4facfe15 0%, #00f2fe15 100%);">
                                ...
                                <h4 class="fw-bold mb-0">
                                    {{ $todayAttendance->check_out_at ? \Carbon\Carbon::parse($todayAttendance->check_out_at)->format('H:i') : '--:--' }}
                                </h4>
                    ...
                    <div class="text-center py-5">
                        ...
                        <a href="{{ route('attendance.check-in') }}" class="btn btn-gradient">
                            <i class="bi bi-fingerprint me-2"></i>
                            Chấm công ngay
                        </a>
                    </div>
            ...
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="alert alert-warning d-flex align-items-center mb-3">
                        ...
                        <div>
                            Bạn có <strong>{{ $pendingLeaves }}</strong> đơn đang chờ duyệt
                        </div>
                    </div>
                    @endif

                    <a href="{{ route('leave-requests.create') }}" class="btn btn-outline-primary w-100 py-3 border-2 border-dashed">
