    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="mb-4">
                ...
                <p class="text-muted mb-0">Cập nhật thông tin cho {{ $employee->name }}</p>
            </div>
                    ...
                    <form method="POST" action="{{ route('employees.update', $employee) }}">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="code" value="{{ old('code', $employee->code) }}" class="form-control" style="border-radius: 12px;" required>
                                @error('code')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Họ tên <span class="text-danger">*</span></label>
                                <input type="text" name="name" value="{{ old('name', $employee->name) }}" class="form-control" style="border-radius: 12px;" required>
                                @error('name')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Email <span class="text-danger">*</span></label>
                                <input type="email" name="email" value="{{ old('email', $employee->email) }}" class="form-control" style="border-radius: 12px;" required>
                                @error('email')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Số điện thoại</label>
                                <input type="text" name="phone" value="{{ old('phone', $employee->phone) }}" class="form-control" style="border-radius: 12px;">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="position" value="{{ old('position', $employee->profile->position) }}" class="form-control" style="border-radius: 12px;">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="base_salary_override" value="{{ old('base_salary_override', $employee->profile->base_salary_override) }}" step="1000" class="form-control" style="border-radius: 12px;">
