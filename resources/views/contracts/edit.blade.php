    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="mb-4">
                ...
                <p class="text-muted mb-0">Cập nhật thông tin hợp đồng: {{ $contract->contract_number }}</p>
            </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" value="{{ $contract->contract_number }}" class="form-control" disabled>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Nhân viên <span class="text-danger">*</span></label>
                                <select name="user_id" class="form-select" required>
                                    @foreach($employees as $emp)
                                        <option value="{{ $emp->id }}" {{ old('user_id', $contract->user_id) == $emp->id ? 'selected' : '' }}>
                                            {{ $emp->name }} ({{ $emp->code }})
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="contract_type" class="form-select" required>
                                    <option value="full_time" {{ old('contract_type', $contract->contract_type) == 'full_time' ? 'selected' : '' }}>Chính thức</option>
                                    <option value="part_time" {{ old('contract_type', $contract->contract_type) == 'part_time' ? 'selected' : '' }}>Part-time</option>
                                    <option value="intern" {{ old('contract_type', $contract->contract_type) == 'intern' ? 'selected' : '' }}>Thực tập</option>
                                    <option value="temporary" {{ old('contract_type', $contract->contract_type) == 'temporary' ? 'selected' : '' }}>Tạm thời</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status" class="form-select" required>
                                    <option value="pending" {{ old('status', $contract->status) == 'pending' ? 'selected' : '' }}>Chờ duyệt</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="start_date" value="{{ old('start_date', $contract->start_date->format('Y-m-d')) }}" class="form-control" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="salary" value="{{ old('salary', $contract->salary) }}" class="form-control" min="0" step="1000" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="position" value="{{ old('position', $contract->position) }}" class="form-control" required>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <textarea name="job_description" class="form-control" rows="4">{{ old('job_description', $contract->job_description) }}</textarea>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="benefits" class="form-control" rows="4">{{ old('benefits', $contract->benefits) }}</textarea>
