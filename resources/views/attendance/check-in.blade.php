                ...
                <div class="card-body p-4 text-center">
                    ...
                    <div class="alert alert-success d-flex align-items-center justify-content-between mb-4">
                        <div class="text-start">
                            ...
                            <h2 class="fw-bold mb-0">{{ \Carbon\Carbon::parse($todayAttendance->check_in_at)->format('H:i') }}</h2>
                            <small class="text-muted">{{ \Carbon\Carbon::parse($todayAttendance->check_in_at)->format('d/m/Y') }}</small>
                        </div>
                        <div>
                ...
                <div class="card-body p-4 text-center">
                    ...
                    <div class="alert alert-info d-flex align-items-center justify-content-between mb-4">
                        <div class="text-start">
                            ...
                            <h2 class="fw-bold mb-0">{{ \Carbon\Carbon::parse($todayAttendance->check_out_at)->format('H:i') }}</h2>
                            <small class="text-muted">{{ \Carbon\Carbon::parse($todayAttendance->check_out_at)->format('d/m/Y') }}</small>
                        </div>
                        <div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body p-4">
                    ...
                    @if($todayAttendance && $todayAttendance->check_in_at && !$todayAttendance->check_out_at)
                    ...
                    @elseif($todayAttendance && $todayAttendance->check_out_at)
                            ...
                            <div class="p-4 rounded-3 d-inline-block" style="background: linear-gradient(135deg, #667eea15 0%, #764ba215 100%);">
                                ...
                                <div id="qrcode-container" style="display: inline-block; min-height: 256px; min-width: 256px; position: relative;">
                                    <img id="qrcode" 
                                         ...
                                         onerror="this.onerror=null; this.src='https://api.qrserver.com/v1/create-qr-code/?size=256x256&data=' + encodeURIComponent('{{ $qrUrl }}');">
                                </div>
                                <div class="mt-3">
                            ...
                            <div class="p-4">
                                ...
                                <div class="alert alert-warning mt-3">
                                    ...
                                    <small>
                                        ...
                                        <strong>URL hiện tại:</strong> <code>{{ $serverUrl }}</code><br>
                                ...
                                <div class="alert alert-info mt-3">
                                    ...
                                    <small>
                                        ...
                                        <strong>IP hiện tại:</strong> <code>{{ $currentIp }}</code><br>
                                        ...
                                        <small class="text-muted">
                                            ...
                                            3. Truy cập từ điện thoại: <code>{{ $serverUrl }}</code> để kiểm tra kết nối<br>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="p-3 rounded-3" style="background: linear-gradient(135deg, #11998e15 0%, #38ef7d15 100%);">
                                ...
                                <h5 class="fw-bold mb-1">
                                    ...
                                    @elseif($todayAttendance->status === 'early_leave')
                        ...
                        <div class="col-md-4">
                            <div class="p-3 rounded-3" style="background: linear-gradient(135deg, #4facfe15 0%, #00f2fe15 100%);">
                                ...
                                <h5 class="fw-bold mb-1">
                                    {{ $todayAttendance->check_in_method === 'qr' ? 'QR Code' : ($todayAttendance->check_in_method === 'mobile' ? 'Mobile' : 'Thủ công') }}
                                </h5>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="p-3 rounded-3" style="background: linear-gradient(135deg, #f093fb15 0%, #f5576c15 100%);">
                                ...
                                <h5 class="fw-bold mb-1">
                                    @if($todayAttendance->check_in_at && $todayAttendance->check_out_at)
                                        {{ \Carbon\Carbon::parse($todayAttendance->check_in_at)->diffInHours(\Carbon\Carbon::parse($todayAttendance->check_out_at)) }}h 
                                        {{ \Carbon\Carbon::parse($todayAttendance->check_in_at)->diffInMinutes(\Carbon\Carbon::parse($todayAttendance->check_out_at)) % 60 }}m
                                    @else
...
<script>
    ...
    (function() {
        ...
        function checkAttendanceStatus(forceCheck = false) {
            ...
            const url = '{{ route("attendance.check-status") }}?t=' + Date.now();
