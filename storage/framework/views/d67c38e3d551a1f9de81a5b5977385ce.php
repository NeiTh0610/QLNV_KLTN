                                ...
                                <div class="d-flex align-items-center">
                                    <div class="me-3" style="width: 40px; height: 40px; border-radius: 10px; overflow:hidden; display:flex; align-items:center; justify-content:center;">
                                        <?php if($employee->avatar_path): ?>
                                            <img src="<?php echo e(asset('storage/'.$employee->avatar_path)); ?>" alt="" style="width:40px;height:40px;object-fit:cover;border-radius:8px;" />
                                        <?php else: ?>
                                            <div style="width:40px;height:40px;background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); display:flex; align-items:center; justify-content:center; color:white; font-weight:700; border-radius:8px;"><?php echo e(strtoupper(substr($employee->name,0,1))); ?></div>
                                        <?php endif; ?>
                                    </div>
                                    <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Administrator\Documents\GitHub\QLNV_KLTN\resources\views/employees/index.blade.php ENDPATH**/ ?>