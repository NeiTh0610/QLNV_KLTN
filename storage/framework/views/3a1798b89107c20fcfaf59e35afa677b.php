    ...
    <div class="app-layout">
        ...
        <div class="sidebar d-flex flex-column" id="sidebar">
                        ...
                        <div style="display:flex;align-items:center;gap:0.75rem">
                            <div style="width:40px;height:40px;border-radius:8px;overflow:hidden;flex-shrink:0">
                                <?php if(auth()->user()->avatar_path): ?>
                                    <img src="<?php echo e(asset('storage/' . auth()->user()->avatar_path)); ?>" alt="avatar" style="width:40px;height:40px;object-fit:cover;display:block;">
                                <?php else: ?>
                                    <div style="width:40px;height:40px;background:linear-gradient(135deg,#22c55e,#10b981);display:flex;align-items:center;justify-content:center;color:#fff;font-weight:700"><?php echo e(strtoupper(substr(auth()->user()->name,0,1))); ?></div>
                                <?php endif; ?>
                            </div>
                            <div>
                                <h6 class="text-white mb-0 fw-bold"><?php echo e(auth()->user()->name); ?></h6>
            ...
            <div class="sidebar-nav flex-grow-1">
                ...
                <a href="<?php echo e(route('password-requests.index')); ?>" class="nav-link <?php echo e(request()->routeIs('password-requests.*') ? 'active' : ''); ?>">
                    <i class="bi bi-key"></i>
            ...
            <div class="p-3">
                <div class="user-profile">
                    ...
                    <div class="mb-2">
                        <a href="<?php echo e(route('logout')); ?>" class="btn btn-light btn-sm w-100">
...
<?php /**PATH C:\Users\Administrator\Documents\GitHub\QLNV_KLTN\resources\views/layouts/app.blade.php ENDPATH**/ ?>