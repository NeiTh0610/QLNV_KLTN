    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="mb-4">
                ...
                <p class="text-muted mb-0">Cập nhật thông tin cho <?php echo e($employee->name); ?></p>
            </div>
                    ...
                    <form method="POST" action="<?php echo e(route('employees.update', $employee)); ?>">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="code" value="<?php echo e(old('code', $employee->code)); ?>" class="form-control" style="border-radius: 12px;" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" value="<?php echo e(old('name', $employee->name)); ?>" class="form-control" style="border-radius: 12px;" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" name="email" value="<?php echo e(old('email', $employee->email)); ?>" class="form-control" style="border-radius: 12px;" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="phone" value="<?php echo e(old('phone', $employee->phone)); ?>" class="form-control" style="border-radius: 12px;">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status" class="form-select" style="border-radius: 12px;" required>
                                    <option value="active" <?php echo e(old('status', $employee->status) == 'active' ? 'selected' : ''); ?>>Đang làm việc</option>
                                    <option value="inactive" <?php echo e(old('status', $employee->status) == 'inactive' ? 'selected' : ''); ?>>Nghỉ việc</option>
                                </select>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Ngày vào làm</label>
                                <input type="date" name="hired_at" value="<?php echo e(old('hired_at', $employee->hired_at?->format('Y-m-d'))); ?>" class="form-control" style="border-radius: 12px;">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Ngày nghỉ việc</label>
                                <input type="date" name="left_at" value="<?php echo e(old('left_at', $employee->left_at?->format('Y-m-d'))); ?>" class="form-control" style="border-radius: 12px;">
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="position" value="<?php echo e(old('position', $employee->profile->position)); ?>" class="form-control" style="border-radius: 12px;">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="role_id" class="form-select" style="border-radius: 12px;" required>
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($role->id); ?>" <?php echo e(old('role_id', $employee->roles->first()?->id) == $role->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="base_salary_override" value="<?php echo e(old('base_salary_override', $employee->profile->base_salary_override)); ?>" step="1000" class="form-control" style="border-radius: 12px;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Administrator\Documents\GitHub\QLNV_KLTN\resources\views/employees/edit.blade.php ENDPATH**/ ?>