...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('leave-requests.create')); ?>" class="btn btn-gradient">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('leave-requests.index')); ?>">
    ...
    <div class="card">
        <div class="card-body p-0">
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-3 px-4">
                                <div class="small"><?php echo e(\Carbon\Carbon::parse($request->start_at)->format('d/m/Y H:i')); ?></div>
                                <div class="text-muted small">đến <?php echo e(\Carbon\Carbon::parse($request->end_at)->format('d/m/Y H:i')); ?></div>
                                <div class="badge bg-light text-dark mt-1"><?php echo e($request->duration_hours); ?> giờ</div>
                            </td>
                            <td class="py-3 px-4">
                            ...
                            <td class="py-3 px-4">
                                <?php if($request->status === 'rejected' && $request->rejection_reason): ?>
                                    <div class="text-danger small" style="max-width: 300px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="<?php echo e($request->rejection_reason); ?>">
                            ...
                            <td class="py-3 px-4 text-end">
                                <form action="<?php echo e(route('leave-requests.approve', $request)); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="btn btn-sm btn-success me-1" style="border-radius: 8px;">
                                        <i class="bi bi-check-lg"></i>
                                    </button>
                                </form>
                                <button onclick="showRejectModal(<?php echo e($request->id); ?>)" class="btn btn-sm btn-danger" style="border-radius: 8px;">
                                    <i class="bi bi-x-lg"></i>
                                </button>
                            </td>
                            <?php elseif(auth()->user()->canManageEmployees()): ?>
                            <td class="py-3 px-4 text-end">
                                <small class="text-muted"><?php echo e($request->approver->name ?? '-'); ?></small>
                            </td>
                            <?php endif; ?>
                        </tr>
            ...
            <div class="p-4 border-top">
                <?php echo e($leaveRequests->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Administrator\Documents\GitHub\QLNV_KLTN\resources\views/leave-requests/index.blade.php ENDPATH**/ ?>